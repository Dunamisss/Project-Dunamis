...
export default function ToyFigureStudio() {
  ...
  const generatedPrompt = useMemo(() => buildPrompt(spec), [spec]);
      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-10 space-y-8">
        <section className="rounded-xl border border-yellow-500/30 bg-black/70 p-6 shadow-lg space-y-3">
          ...
          <p className="text-sm text-gray-300 max-w-4xl">
            Upload a photo into your image model, then use this builder to generate a premium action-figure prompt and JSON blueprint.
            It is designed for beginners: fill a few fields, copy, and run.
          </p>
        ...
        <section className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          <div className="rounded-xl border border-yellow-500/25 bg-black/70 p-5 space-y-4">
            <h2 className="text-xl font-semibold text-yellow-200">Figure Setup</h2>
          ...
          <div className="rounded-xl border border-yellow-500/25 bg-black/70 p-5 space-y-4">
            ...
            <div className="rounded-md border border-yellow-500/20 bg-black/30 p-4 text-sm text-gray-300 space-y-2">
              <p>1. Upload your photo in your image model tool.</p>
              <p>2. Fill this form with the toy style you want.</p>
              <p>3. Copy the prompt or JSON and generate.</p>
              <p>4. If needed, click <span className="text-yellow-200">Open In Optimizer</span> to refine before generation.</p>
            </div>
